        ...
        <div className="bg-blue_gray-900_a2 flex flex-col gap-[51px] items-center justify-start p-[79px] md:px-10 sm:px-5 w-full">
          <div className="flex flex-row gap-3.5 items-center justify-center w-[22%] md:w-full">
            <Img
              ...
              src="images/img_group1_white_a700.svg"
              alt="groupOne"
            />
            <Text
          ...
          <div className="bg-white-A700 flex flex-col gap-5 items-center justify-center mb-[111px] p-[21px] md:px-5 rounded-[15px] w-[48%] md:w-full">
            ...
            <div className="flex flex-col gap-[15px] items-center justify-start mb-24 w-full">
              <Input
                name="groupFortyFive"
                placeholder="Enter Your Email"
                className="leading-[normal] p-0 placeholder:text-blue_gray-900 sm:pl-5 text-[15px] text-blue_gray-900 text-left w-full"
                wrapClassName="bg-white-A700 border border-blue_gray-900 border-solid flex pl-[21px] pr-3 py-[13px] rounded-[5px] w-full"
                type="email"
                prefix={
